        ...
        <Router>
          ...
          <div className="container " style={{ marginTop: '80px' }}>
            <Routes>
              ...
              <Route exact path="/about" element={<News setProgress={this.setProgress} key="business" pageSize={this.pageSize} country={'us'} category='business' />} ></Route>
              ...
              <Route exact path="/home" element={<News setProgress={this.setProgress} key="general" pageSize={this.pageSize} country={'us'} category='general' />}></Route>
            </Routes>
          </div >
        </Router >
      </>
